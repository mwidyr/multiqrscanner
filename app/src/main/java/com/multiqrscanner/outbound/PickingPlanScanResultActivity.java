...
public class PickingPlanScanResultActivity extends AppCompatActivity {
    private static String TAG = "PPSRA";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_picking_plan_scan_result);
