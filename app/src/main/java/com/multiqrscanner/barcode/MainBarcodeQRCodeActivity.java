 ...
 * reads barcodes.
 */
public class MainBarcodeQRCodeActivity extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_qrcode_barcode_main);
...
//        Bitmap myBitmap = BitmapFactory.decodeResource(getApplicationContext().getResources(),R.drawable.sample_multiple_barcode);
        ...
        if (requestCode == RC_BARCODE_CAPTURE) {
            if (resultCode == CommonStatusCodes.SUCCESS) {
                if (data != null) {
                    ...
                    barcodeValue.setText("displayValue : " + barcode.displayValue + "\nformat : " + barcode.format + "\nvalueFormat : " + barcode.valueFormat );
